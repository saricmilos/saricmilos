// Wind Turbine Selection Functionality
document.addEventListener('DOMContentLoaded', function() {
    ...
    const turbineDetailImage = document.getElementById('turbine-detail-image');
    ...
    function createTurbineModelCard(model) {
        ...
        card.innerHTML = `
            <img src="${model.image}" alt="${model.name}" class="turbine-model-image">
    ...
    function showTurbineDetails(turbine) {
        ...
        turbineDetailImage.src = turbine.image;
        turbineDetailImage.alt = turbine.name;
